...
// --- FIX: Set proper base path ---
// This ensures all paths work regardless of where the file is included from
...
// FIX: Use absolute path from server root
...
// --- UI RENDERING ---
// FIX: Set proper base URL for AJAX requests
$ajax_base = $_SERVER['SCRIPT_NAME'] . '?';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
// FIX: Use absolute URL for AJAX requests
...
// FIX: Initialize after page load
